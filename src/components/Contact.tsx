...
export default function Contact() {
  ...
  return (
    <section id="contacto" className="py-32 relative rune-bg z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" ref={ref}>
        ...
        <div className="max-w-3xl mx-auto">
          <motion.div
            ...
            className="card-stone p-12 text-center"
          >
            <h3 className="font-cinzel text-3xl font-bold text-gold mb-5">
              ¿TENÉS DUDAS?
            </h3>
            <p className="text-text-muted text-xl mb-10">Contactanos por WhatsApp</p>
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center gap-4 px-10 py-5 rounded-full font-bold text-foreground text-2xl mb-10"
              style={{
