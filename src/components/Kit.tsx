...
export default function Kit() {
  ...
  return (
    <section id="kit" className="py-32 relative rune-bg z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-10">
            ...
            <ul className="space-y-4">
              {kitIncludes.map((item, index) => (
                <motion.li
                  ...
                  className="flex items-center gap-4 p-4 transition-all hover:bg-stone-medium/50 rounded"
                >
                  <span className="text-gold text-xl flex-shrink-0">+</span>
                  <span className="text-foreground/90 text-lg">{item.text}</span>
                </motion.li>
              ))}
            </ul>
          </motion.div>
          ...
          >
            <div className="card-stone p-8">
              <h4 className="font-cinzel font-bold text-foreground mb-5 flex items-center gap-3 text-xl">
                <span className="text-fire-orange font-cinzel-decorative text-lg">I</span>
                Todos los participantes:
              </h4>
              <ul className="space-y-3">
                <li className="flex items-start gap-3 text-text-muted text-lg">
            ...
            <div className="card-stone p-8">
              <h4 className="font-cinzel font-bold text-foreground mb-5 flex items-center gap-3 text-xl">
                <span className="text-ice-blue font-cinzel-decorative text-lg">II</span>
